...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      for (User user : carServise.getUsersByModel(car1.getModel())) {
         userPrintInfo(user);
      }
   ...
   public static void userPrintInfo(User user) {
      ...
      Car car = user.getCar();
      if(car != null) {
         System.out.println("car: id = " + car.getId() + ", model = " + car.getModel() + ", series = " + car.getSeries());
      }
      System.out.println();
   }
}
